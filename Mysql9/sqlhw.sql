...
#2a. You need to find the ID number, first name, and last name of an actor, of whom you know only the first name, "Joe." What is one query would you use
...
# 3a. You want to keep a description of each actor. You don't think you will be performing queries # on a description, so create a column in the table 
     ALTER TABLE actor 
     ADD middle_name VARCHAR(45) NULL AFTER first_name;

# 3actor named description and use the data type BLOB (Make sure to research the type BLOB, as the difference between it and VARCHAR are significant).
    ALTER TABLE actor 
